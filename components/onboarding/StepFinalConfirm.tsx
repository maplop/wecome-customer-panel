...
export default function StepFinalConfirm({ amount, term, onConfirm, onBack }: StepFinalConfirmProps) {
    ...
    <div className="flex flex-col gap-6">
      ...
      <label className="flex items-start gap-3 cursor-pointer group">
        <div className="relative mt-0.5 shrink-0">
          ...
          />
          <div
            className={`h-5 w-5 rounded-md border-2 flex items-center justify-center transition ${agreed ? 'border-transparent' : 'border-border group-hover:border-muted-foreground'}`}
            style={agreed ? { backgroundColor: '#E1941F' } : {}}
          >
            {agreed && (
        ...
        <span className="text-xs text-muted-foreground leading-relaxed">
          ...
          <span className="font-medium underline" style={{ color: '#E1941F' }}>Términos y Condiciones</span>
          {' '}y el{' '}
          <span className="font-medium underline" style={{ color: '#E1941F' }}>Aviso de Privacidad</span>
